=== Pronamic Post Activation ===
Contributors: pronamic, remcotolsma 
Tags: post, activation, activate, deactive, key
Donate link: http://pronamic.eu/donate/?for=wp-plugin-pronamic-post-activation&source=wp-plugin-readme-txt
Requires at least: 3.0
Tested up to: 3.4.1
Stable tag: 0.1

The Pronamic Post Activation plugin allows you to activate and deactivate posts through an URL with an key.
...
*	**Activate link**
		...
		[pronamic_post_activate_link post_id="1234"]Activate post[/pronamic_post_activate_link]

	In Gravity Forms post create form notification e-mails you could use the following shortcode:

		[pronamic_post_activate_link post_id="{post_id}"]Activate post[/pronamic_post_activate_link]

*	**Activate link**
	
		[pronamic_post_deactivate_link post_id="1234"]Deactivate post[/pronamic_post_deactivate_link]

	In Gravity Forms post create form notification e-mails you could use the following shortcode:

		[pronamic_post_deactivate_link post_id="{post_id}"]Deactivate post[/pronamic_post_deactivate_link]
